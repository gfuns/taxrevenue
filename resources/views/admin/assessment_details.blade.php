            ...
            <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-6">
                        ...
                        <div class="col-12">
                            <a href="{{ route("admin.downloadPayAdvise", [$trx->reference]) }}" target="_blank"><button class="btn btn-outline-success w-100"
                                    type="button">Download Payment Advise</button></a>
