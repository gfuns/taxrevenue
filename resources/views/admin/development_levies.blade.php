...
@section('content')
@section('title', env('APP_NAME') . ' | Development Levies')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h3 fw-bold">Development Levies</h1>
                    <!-- Breadcrumb -->
...
<script type="text/javascript">
    ...
    document.getElementById("devlevies").classList.add('active');
</script>
