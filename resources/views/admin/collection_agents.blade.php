...
@section('content')
@section('title', env('APP_NAME') . ' | Collection Agents')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h3 fw-bold">Collection Agents</h1>
                    <!-- Breadcrumb -->
                ...
                @if (\App\Http\Controllers\MenuController::canCreate(Auth::user()->role_id, 1) == true)
                    ...
                    <div>
                        <a href="#" class="btn btn-success btn-sm me-2" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasRight">Add New Collection Agent</a>
                        ...
                        <div class="col-12 col-lg-9 mb-3 mb-lg-0">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input name="search" type="search" class="form-control ps-6"
                                    placeholder="Search Collection Agents......" value="{{ $search }}">
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="text-inherit">
                                                        <img src="{{ $agent->photo }}" alt="" class="circle"
                                                            style="height: 50px; width:50px; border-radius: 50%; object-fit: cover; border: 2px solid #ccc;">

                                                        <span class="ms-2 text-gray-500">{{ $agent->surname }}</span>
                                                    </a>
                                                </td>

                                                <td>{{ $agent->first_name . ' ' . $agent->other_names }}
                                                </td>
                                                <td>{{ $agent->email }}</td>
                                                <td>{{ $agent->phone_number }}</td>
                                                <td>{{ ucwords($agent->gender) }}</td>
                                                <td>
                                                    @if ($agent->status == 'active')
                                                        <span
                                                            class="badge text-success bg-light-success">{{ ucwords($agent->status) }}</span>
                                                    @else
                                                        <span
                                                            class="badge text-danger bg-light-danger">{{ ucwords($agent->status) }}</span>
                                                    @endif
                                                </td>
                                                        ...
                                                        <span class="dropdown dropstart">
                                                            ...
                                                            <span class="dropdown-menu"><span
                                                                ...
                                                                <a style="cursor:pointer" class="dropdown-item"
                                                                    ...
                                                                    data-bs-target="#viewAgentDetails"
                                                                    data-myid="{{ $agent->id }}"
                                                                    ...
                                                                    data-pos="{{ $agent->posDetails() }}"
                                                                    data-photo="{{ $agent->photo }}"
                                                                    data-gender="{{ ucwords($agent->gender) }}"><i
                            ...
                            @if (count($agents) > 0 && $marker != null)
                                <div class="card-footer">
                                    <div class="row g-2 pt-3 ms-4 me-4">
                                        ...
                                        <div class="col-md-3">{{ $agents->appends(request()->input())->links() }}
                                        </div>
                                    </div>
                                </div>
                            @endif
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel"> Add New Collection Agent</h3>
            ...
            <div class="container">
                ...
                <form class="needs-validation" novalidate method="post"
                    action="{{ route('admin.storeCollectionAgent') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- form group -->
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <textarea name="assigned_location" class="form-control" placeholder="Assigned Location" required rows="5"
...
@if (\App\Http\Controllers\MenuController::canEdit(Auth::user()->role_id, 1) == true)
    <div class="offcanvas offcanvas-end" tabindex="-1" id="editAgent" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel"> Edit Collection Agent Details</h3>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                    aria-label="Close"></button>
            </div>
            <!-- card body -->
            <div class="container">
                <!-- form -->
                <form class="needs-validation" novalidate method="post"
                    action="{{ route('admin.updateCollectionAgent') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- form group -->
                        <div class="mb-3 col-12 col-md-6">
                        ...
                        <input id="myid" type="hidden" name="agent_id" class="form-control" required>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="assignTerminal" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel">Assign POS Terminal</h3>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                    aria-label="Close"></button>
            </div>
            <!-- card body -->
            <div class="container">
                ...
                <form method="post" class="needs-validation" novalidate
                    action="{{ route('admin.assignTerminal') }}">
                    @csrf
                    <div class="row">
                        <div class="mb-3 col-12">
                            <label class="form-label">POS Terminal <span class="text-danger">*</span></label>
                            <select id="posTerminal" name="pos_terminal" class=" form-control" data-width="100%"
                                required>
                        ...
                        <!-- button -->
                        <div class="col-12 mt-4">
                            <button class="btn btn-success" type="submit">Assign Terminal</button>
                            <button type="button" class="btn btn-outline-success ms-2" data-bs-dismiss="offcanvas"
                                aria-label="Close">Close</button>
                        </div>
                    </div>
...
<div class="modal fade" id="viewAgentDetails" tabindex="-1" role="dialog" aria-labelledby="newCatgoryLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td class="">Assigned Location</td>
                            <td class=""><span id="vlocation"></span></td>
                        </tr>

                        <tr>
                            <td class="">Assigned POS</td>
                            <td class=""><span id="vpos"></span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
