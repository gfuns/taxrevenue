                ...
                @if (\App\Http\Controllers\MenuController::canCreate(Auth::user()->role_id, 1) == true)
                    ...
                    <div>
                        <a href="#" class="btn btn-success btn-sm me-2" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasRight">Add New Tax Office</a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel">Add New Area Tax Office</h3>
            ...
            <div class="container">
                <!-- form -->
                <form class="needs-validation" novalidate method="post" action="{{ route('admin.storeTaxOffice') }}">
                    @csrf
                    <div class="row">
                        <!-- form group -->
                        <div class="mb-3 col-12">
                            <label class="form-label">Tax Office <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <div class="invalid-feedback">Please provide office address.</div>
                        </div>
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <div class="invalid-feedback">Please select LGA.</div>
                        </div>
...
@if (\App\Http\Controllers\MenuController::canEdit(Auth::user()->role_id, 1) == true)
    <div class="offcanvas offcanvas-end" tabindex="-1" id="editTaxOffice" style="width: 600px;">
        <div class="offcanvas-body" data-simplebar>
            <div class="offcanvas-header px-2 pt-0">
                <h3 class="offcanvas-title" id="offcanvasExampleLabel"> Edit Area Tax Office Details</h3>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                    aria-label="Close"></button>
            </div>
            <!-- card body -->
            <div class="container">
                ...
                <form class="needs-validation" novalidate method="post" action="{{ route('admin.updateTaxOffice') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            <label class="form-label">Office Address <span class="text-danger">*</span></label>
                            <textarea id="address" name="office_address" class="form-control" placeholder="Enter Office Address" required
                        ...
                        <input id="myid" type="hidden" name="office_id" class="form-control" required>
...
<script type="text/javascript">
    ...
    document.getElementById("taxOffice").classList.add('active');
</script>
