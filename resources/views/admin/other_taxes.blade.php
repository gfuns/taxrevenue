...
@section('content')
@section('title', env('APP_NAME') . ' | Other Taxes/Revenue')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h3 fw-bold">Other Taxes/Revenue</h1>
                    <!-- Breadcrumb -->
...
<script type="text/javascript">
    ...
    document.getElementById("othertaxes").classList.add('active');
</script>
