            ...
            <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-6">
                        ...
                        @if (
                            \App\Http\Controllers\MenuController::canEdit(Auth::user()->role_id, 5) == true &&
                            ...
                            <div class="row col-12 d-flex align-items-center justify-content-between">
                                <div class="col-6">
                                    <a href="{{ route('admin.approvePrfApplication', [$trx->id]) }}"
...
<div class="modal fade" id="rejectApplication" tabindex="-1" role="dialog" aria-labelledby="newCatgoryLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.rejectPrfApplication') }}" method="POST" class="needs-validation"
                novalidate>
                @csrf
