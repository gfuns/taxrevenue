                            ...
                            <form method="post" action="{{ route('admin.updateProfile') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-4">
                                        ...
                                        <span role="alert">
                                            <strong style="color: #b02a37; font-size:11px">Please Upload Profile
                                                Photo</strong>
                                        </span>
                        ...
                        <div class="card-body p-lg-6">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="">Assigned MDA</td>
                                        <td class="">{{ Auth::user()->mda->mda }}</td>
                                    </tr>
                                    <tr>
                                        <td class="">MDA Code</td>
                                        <td class="">{{ Auth::user()->mda->mda_code }}</td>
                                    </tr>
                                </tbody>
                            </table>
