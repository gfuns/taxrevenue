            ...
            <section class="section-box">
                <div class="breadcrumb-cover page_speed_160581955"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <h2 class="mb-10" style="color:#fff">Platform Categories</h2>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row job-categories">
                            @foreach ($categories as $cat)
                                <div class="col-xl-3 col-sm-1 col-xs-1"><a href="/job-categories/{{ $cat->slug }}">
                                        <div class="item-logo">
                                            <div class="image-left"><img src="{{ $cat->category_icon }}" alt="#"
