<div class="modal fade report_modal" id="exampleModal" tabindex="-1"
            ...
            <form id="report_form">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit"
                            class="report_sent btn btn-success post-details-report-modal">Send</button>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-4">
                            <div class="row d-none">
                                <input class="form--control d-none" hidden="" placeholder=""
                                    name="post_type" value="text" id="post_type">
                            </div>
                        ...
                        <div class="form-group mb-4">
                            <input class="form--control" type="file" name="images[]"
                                accept=".png, .jpg, .jpeg" multiple="" id="images[]">
                            <label class="form--label" for="images[]">Image</label>
                        </div>

                        <div class="form-group mb-4">
                            <textarea class="form--control trumEdit" placeholder="" name="content" id="content" style="display: none;"></textarea>
                            <div class="ck ck-reset ck-editor ck-rounded-corners" role="application"
                                dir="ltr" lang="en"
                                aria-labelledby="ck-editor__label_e071813e29c4b18cb4eae110e84f66587"><label
                                    class="ck ck-label ck-voice-label"
                                    id="ck-editor__label_e071813e29c4b18cb4eae110e84f66587">Rich Text
                                    Editor</label>
                                        ...
                                        <div class="ck ck-sticky-panel__content">
                                            <div class="ck ck-toolbar ck-toolbar_grouping" role="toolbar"
                                                ...
                                                <div class="ck ck-toolbar__items"><button
                                                        ...
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e43a5be09214b3212383684076860f921"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_e43a5be09214b3212383684076860f921">Undo</span></button><button
                                                        class="ck ck-button ck-disabled ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e8c52544d34da060fa8bf309602ef3d18"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_e8c52544d34da060fa8bf309602ef3d18">Redo</span></button>
                                                    <div class="ck ck-dropdown ck-heading-dropdown"><button
                                                            class="ck ck-button ck-off ck-button_with-text ck-dropdown__button"
                                                            type="button" tabindex="-1"
                                                            aria-labelledby="ck-editor__aria-label_e50aa162856bbb1f29fd9461520a6d0f7"
                                                            data-cke-tooltip-text="Heading"
                                                            data-cke-tooltip-position="s" aria-haspopup="true"
                                                            aria-expanded="false"><span
                                                                class="ck ck-button__label"
                                                                id="ck-editor__aria-label_e50aa162856bbb1f29fd9461520a6d0f7">Paragraph</span><svg
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="ck ck-reset ck-list">
                                                                <li class="ck ck-list__item"><button
                                                                        ...
                                                                        type="button" tabindex="-1"
                                                                        aria-labelledby="ck-editor__aria-label_e8fd50b7525a29f0961f8394c99924509"
                                                                        data-cke-tooltip-position="s"><span
                                                                            class="ck ck-button__label"
                                                                            id="ck-editor__aria-label_e8fd50b7525a29f0961f8394c99924509">Paragraph</span></button>
                                                                </li>
                                                                <li class="ck ck-list__item"><button
                                                                        class="ck ck-button ck-heading_heading1 ck-off ck-button_with-text"
                                                                        type="button" tabindex="-1"
                                                                        aria-labelledby="ck-editor__aria-label_e286293d6516e6ececdc0337eab039965"
                                                                        data-cke-tooltip-position="s"><span
                                                                            class="ck ck-button__label"
                                                                            id="ck-editor__aria-label_e286293d6516e6ececdc0337eab039965">Heading
                                                                            1</span></button></li>
                                                                <li class="ck ck-list__item"><button
                                                                        class="ck ck-button ck-heading_heading2 ck-off ck-button_with-text"
                                                                        type="button" tabindex="-1"
                                                                        aria-labelledby="ck-editor__aria-label_e479247b02e8324521c9235ecf2fe25c7"
                                                                        data-cke-tooltip-position="s"><span
                                                                            class="ck ck-button__label"
                                                                            id="ck-editor__aria-label_e479247b02e8324521c9235ecf2fe25c7">Heading
                                                                            2</span></button></li>
                                                                <li class="ck ck-list__item"><button
                                                                        class="ck ck-button ck-heading_heading3 ck-off ck-button_with-text"
                                                                        type="button" tabindex="-1"
                                                                        aria-labelledby="ck-editor__aria-label_e0aef046adbe3b698ea15e10748fc2cbb"
                                                                        data-cke-tooltip-position="s"><span
                                                                            class="ck ck-button__label"
                                                                            id="ck-editor__aria-label_e0aef046adbe3b698ea15e10748fc2cbb">Heading
                                                                            3</span></button></li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_efe64269dc63630b5e0816cd85355e0c4"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_efe64269dc63630b5e0816cd85355e0c4">Bold</span></button><button
                                                        class="ck ck-button ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e9b53a8720772c9e993d5a852a4391a69"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_e9b53a8720772c9e993d5a852a4391a69">Italic</span></button><button
                                                        class="ck ck-button ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_ee00ecd48c8dc1d8afc048cbce1cc2246"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_ee00ecd48c8dc1d8afc048cbce1cc2246">Link</span></button><button
                                                        class="ck ck-button ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_ed55f3d184de2c4852cecc48b4412122c"
                                                        aria-pressed="false"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_ed55f3d184de2c4852cecc48b4412122c">Bulleted
                                                            List</span></button><button
                                                        class="ck ck-button ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_ee06654cb6abe96e2093b54ad8279a38e"
                                                        aria-pressed="false"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_ee06654cb6abe96e2093b54ad8279a38e">Numbered
                                                            List</span></button><span
                                                        class="ck ck-toolbar__separator"></span><button
                                                        class="ck ck-button ck-disabled ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e6bbcfeea5da08acbdf6ec24e20737d15"
                                                        aria-disabled="true"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_e6bbcfeea5da08acbdf6ec24e20737d15">Decrease
                                                            indent</span></button><button
                                                        class="ck ck-button ck-disabled ck-off" type="button"
                                                        tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e06b08dd3c5e672f5e852f7529687ba6c"
                                                        aria-disabled="true"
                                                        ...
                                                        data-cke-tooltip-position="s"><svg
                                                            ...
                                                            id="ck-editor__aria-label_e06b08dd3c5e672f5e852f7529687ba6c">Increase
                                                    ...
                                                    <div class="ck ck-dropdown">
                                                        <div class="ck ck-splitbutton ck-dropdown__button"><span
                                                                class="ck-file-dialog-button ck ck-button ck-splitbutton__action"><button
                                                                    class="ck ck-button ck-off" type="button"
                                                                    tabindex="-1"
                                                                    aria-labelledby="ck-editor__aria-label_ed40bc7768fbbdb9f167325622400e6ef"
                                                                    ...
                                                                    data-cke-tooltip-position="s"><svg
                                                                        ...
                                                                        id="ck-editor__aria-label_ed40bc7768fbbdb9f167325622400e6ef">Insert
                                                                        image</span></button><input
                                                                    class="ck-hidden" type="file"
                                                                    tabindex="-1"
                                                                ...
                                                                type="button" tabindex="-1"
                                                                aria-labelledby="ck-editor__aria-label_ecbb8c6fb67943c5dfe4bbe5978ef90b8"
                                                                data-cke-tooltip-text="Insert image"
                                                                ...
                                                                aria-haspopup="true" aria-expanded="false"><svg
                                                                    ...
                                                                    id="ck-editor__aria-label_ecbb8c6fb67943c5dfe4bbe5978ef90b8">Insert
                                                    ...
                                                    <div class="ck ck-dropdown"><button
                                                            ...
                                                            type="button" tabindex="-1"
                                                            aria-labelledby="ck-editor__aria-label_e5444e565d46dc7d0096df8319815392d"
                                                            ...
                                                            aria-expanded="false"><svg
                                                                ...
                                                                id="ck-editor__aria-label_e5444e565d46dc7d0096df8319815392d">Insert
                                                                table</span><svg
                                                                class="ck ck-icon ck-reset_all-excluded ck-icon_inherit-color ck-dropdown__arrow"
                                                                viewBox="0 0 10 10">
                                                                <path
                                                        ...
                                                        type="button" tabindex="-1"
                                                        aria-labelledby="ck-editor__aria-label_e9986cf96e5e223c06dd776e09d58a16e"
                                                        data-cke-tooltip-text="Source"
                                                        data-cke-tooltip-position="s"><svg
                                                            class="ck ck-icon ck-reset_all-excluded ck-icon_inherit-color ck-button__icon"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                            ...
                                                            id="ck-editor__aria-label_e9986cf96e5e223c06dd776e09d58a16e">Source</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <form method="POST" action="https://preview.wstacks.com/proforum/user/post/store"
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-4">
                            <div class="row d-none">
                                <input class="form--control d-none" hidden="" placeholder=""
                                    name="post_type" value="job" id="post_type">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <input type="text" class="form-control form--control" id="title"
                        ...
                        <div class="form-group mb-4">
                            <input class="form-control form--control" type="number" placeholder=""
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="ck ck-reset ck-editor ck-rounded-corners" role="application"
                                dir="ltr" lang="en"
                                aria-labelledby="ck-editor__label_e1387ed700e5ddd67804957d7325cc2a9"><label
                                    class="ck ck-label ck-voice-label"
                ...
                <form method="POST" action="https://preview.wstacks.com/proforum/user/post/store"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-4">
                            <div class="row d-none">
                                <input class="form--control d-none" hidden="" placeholder=""
                                    name="post_type" value="event" id="post_type">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-xl-6">
                                <div class="form-group mb-4">
                                    <input class="form-control form--control" type="datetime-local"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="ck ck-reset ck-editor ck-rounded-corners" role="application"
                                dir="ltr" lang="en"
                                aria-labelledby="ck-editor__label_e32a313d9ee292d595e86b6a5533b8fa2"><label
                                    class="ck ck-label ck-voice-label"
