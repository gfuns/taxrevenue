                        ...
                        <ul>
                            ...
                            <li class="login-registration-list login-icon">
                                <a href="https://preview.wstacks.com/proforum/user/login"
                                    class="login-registration-list__link">
                                    <span class="icon">
            ...
            <div class="header-menu-wrapper align-items-center d-flex">
                <div class="logo-wrapper">
                    <a href="/" class="normal-logo"
                        id="offcanvas-logo-normal"> <img
                            src="{{ asset('files/general/logo.png') }}"
                            alt=""></a>
                    <a href="/" class="dark-logo hidden"
                        id="offcanvas-logo-dark"> <img
                            src="{{ asset('files/general/logo.png') }}"
                            alt=""></a>
                </div>
            </div>
