...
@section('content')
@section('title', env('APP_NAME') . ' | Topical Posts')
                                    ...
                                    @php
                                        ...
                                        if(isset($post->forum_category_id)){
                                            if($post->category->category == "Events"){
                                                $category = "event";
                                            }else if($post->category->category == "Jobs"){
                                                $category = "job";
                                            }
                                        ...
                                        <div class="card-auth-meta">
                                            <div class="auth-info">
                                                <a href="/forum/user-profile/{{ $post->customer_id }}">
                                                    ...
                                                    <p class="post-by">Posted by <span>{{ $post->customer->first_name." ".$post->customer->last_name }}</span>
                                                    </p>
                                                </a>
                                                <i class="fa-solid fa-circle"></i>
                                                <p title="25 Oct, 2023 10:42 PM" class="time-status">{{ $post->created_at->diffForHumans() }}
                                                </p>
                                            ...
                                            <div class="actn-dropdown-box">
                                                @if(isset($post->forum_category_id))
                                                <span class="badge-{{ $category }}">{{ $post->category->category }}</span>
                                                @endif
...
<script type="text/javascript">
    var icon = "iconft"+{{ Js::from($id) }};
    var menu = "menuft"+{{ Js::from($id) }};
