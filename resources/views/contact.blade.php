				...
				<div class="flex items-center justify-between h-20">
					...
					<div class="flex items-center space-x-4">
						...
						<a href="/register"><button
							class="bg-[#02611A] hover:bg-green-600 text-white px-6 py-2.5 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50 font-jaka font-normal text-[16px] leading-[24.4px] tracking-[0%]">
							Get Started
						</button></a>
		...
		<main>
			<div
				...
				<div
					...
					<img
						src="{{ asset("website/assets/images/contact-image.png")}}"
						alt="Handshake"
