                    ...
                    <div class="p-4 row gx-3">
                        ...
                        <div class="col-6 col-lg-3">
                            ...
                            <select id="status" name="status" class="form-select" onChange="this.form.submit()">
                                ...
                                <option value="successful" @if ($status == 'successful') selected @endif>Payment
                                    Successful
                                </option>
                                <option value="failed" @if ($status == 'failed') selected @endif>Payment
                                    Failed</option>
                            </select>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($transactions as $trx)
                                            <tr>
                                                ...
                                                <td>{{ date_format(new DateTime($trx->award_date), 'jS M, Y g:ia') }}
                                                </td>
                                                            ...
                                                            <span class="dropdown-menu"><span
                                                                ...
                                                                @if ($trx->status == 'pending')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('individual.paymentPreview', [$trx->reference]) }}"><i
                                                                            class="fe fe-credit-card dropdown-item-icon"></i>Make
                                                                        Payment</a>
                                                                @endif
                                                                ...
                                                                @if ($trx->status == 'successful')
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('individual.paymentDetails', [$trx->reference]) }}"><i
                                                                            class="fe fe-eye dropdown-item-icon"></i>View
                                                                        Details</a>

                                                                    <a class="dropdown-item"
                                                                        href="{{ route('receipt.paymentReceipt', [$trx->reference]) }}"
                                                                        target="_blank"><i
