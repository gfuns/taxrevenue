				...
				<div class="flex items-center justify-between h-20">
					...
					<nav class="items-center hidden space-x-2 lg:flex">
						<a
							href="/"
							data-page="home"
							class="nav-link hover:text-primary transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-100 font-sora font-normal text-[19px] leading-[26.6px] tracking-[0%] text-[#232323]">
							Home
						</a>
						<a
							href="/about"
						...
						<div class="relative group">
							<button
								class="nav-link hover:text-primary flex items-center hover:text-primary transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-100 font-sora font-normal text-[19px] leading-[26.6px] tracking-[0%] text-[#232323]"
								data-page="media">
								Media
								<svg
			...
			<div
				...
				<div class="px-4 pt-4 pb-6 space-y-2">
					<a
						href="/index"
						data-page="home"
						class="block px-4 py-3 text-base font-medium text-gray-700 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-600 hover:bg-gray-100">
						Home
					</a>
					<a
						href="/about"
					...
					<div class="space-y-1">
						<button
							...
							data-page="media"
							class="flex items-center justify-between w-full px-4 py-3 text-base font-medium text-gray-700 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-600 hover:bg-gray-100">
							Media
							<svg
								id="submenu-arrow"
						...
						<div id="mobile-submenu" class="hidden pl-4 space-y-1">
							<a
								href="/news"
								data-page="news"
								class="block px-4 py-2 text-sm text-gray-600 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-600 hover:bg-gray-100">
								News & Updates
							</a>
							<a
								href="/press"
						...
						<div class="overflow-x-auto">
							<table class="w-full">
								...
								<tbody class="bg-white divide-y divide-gray-200">
									<tr class="even:bg-white odd:bg-[#EEFFF2] hover:bg-gray-100">
