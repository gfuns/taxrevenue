        ...
        <div class="page-ath-content">
            ...
            <div class="page-ath-form" style="width: 500px">
                ...
                <p>Hello <strong>{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</strong>,
                    <br>Enter the verification code generated by your mobile application (Google Authenticator).
                </p>
                ...
                <div class="form-note">
                    If you lost your phone or Uninstall the Google Authenticator app and enable to access your account
