		...
		<header class="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
			<div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
				<div class="flex items-center justify-between h-20">
							...
							<div
								...
								<div class="py-2">
									<a
										href="/news"
										data-page="news"
										class="flex items-center px-4 py-3 text-base transition-colors duration-200 dropdown-link hover:bg-green-600 hover:text-white">
										<svg
											class="w-4 h-4 mr-3"
											fill="none"
											stroke="currentColor"
									...
									<a
										href="/resources"
										data-page="resources"
										class="flex items-center px-4 py-3 text-sm transition-colors duration-200 dropdown-link hover:bg-green-600 hover:text-white">
										<svg
											class="w-4 h-4 mr-3"
											fill="none"
											stroke="currentColor"
					...
					<div class="flex items-center space-x-4">
						...
						<button
							type="button"
							class="flex items-center justify-center w-10 h-10 text-gray-700 transition-colors duration-200 rounded-lg lg:hidden hover:text-green-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50"
          ...
          Home
					...
					<a
						href="/about"
						data-page="about"
						class="block px-4 py-3 text-base font-medium text-gray-700 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-800 hover:bg-gray-50">
						About Us
					</a>
					<a
						href="/tenders"
					...
					<div class="space-y-1">
						<button
							...
							data-page="media"
							class="flex items-center justify-between w-full px-4 py-3 text-base font-medium text-gray-700 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-800 hover:bg-gray-50">
							Media
							<svg
								id="submenu-arrow"
						...
						<div id="mobile-submenu" class="hidden pl-4 space-y-1">
							<a
								href="/news"
								data-page="news"
								class="block px-4 py-2 text-sm text-gray-600 transition-colors duration-200 rounded-lg mobile-nav-link hover:text-green-800 hover:bg-gray-50">
								News & Updates
							</a>
							<a
								href="/press"
			...
			<section class="px-16 py-10 mx-auto max-w-7xl">
				<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
					...
					<div class="overflow-hidden bg-white shadow-sm">
						<img
							src="{{ asset("website/assets/images/Image.png")}}"
							alt=""
						...
						<div class="p-5 space-y-2">
							...
							<div class="flex items-center justify-between">
								...
								<span class="text-lg text-gray-500"
									><img src="{{ asset("website/assets/images/Icon wrap.png")}}" alt="icon-wrap"
								/></span>
							</div>
							<p
					...
					<!-- Card 2 -->
					<div class="overflow-hidden bg-white shadow-sm">
						<img src="{{ asset("website/assets/images/Image.png")}}" alt="" class="p-3" />
						<div class="p-5 space-y-2">
							<p
								class="font-jaka font-normal text-[16px] leading-[22.4px] tracking-[0%] text-[#02611A]">
							...
							<div class="flex items-center justify-between">
								...
								<span class="text-lg text-gray-500"
									><img src="{{ asset("website/assets/images/Icon wrap.png")}}" alt=""
								/></span>
							</div>
							<p
								class="font-jaka font-normal text-[16px] leading-[22.4px] tracking-[0%] text-[#667085]">
				...
				<div class="flex justify-center mt-10">
					<button
						...
						<img src="{{ asset("website/assets/images/Icon.png")}}" alt="Icon" class="w-4 h-4" />
						<span>Load more</span>
					</button>
				</div>
			</section>
