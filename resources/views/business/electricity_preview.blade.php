            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-6" style="margin-left: 0px; padding-left:0px">
                        <!-- First button -->
                        <a href="{{ route('business.pointsElectricityPurchase', [$trx->transaction_id]) }}"><button class="btn btn-primary pr-12" type="button"
                    ...
                    <div class="col-md-4 col-6">
                        ...
                        <a href="{{ route('business.walletElectricityPurchase', [$trx->transaction_id]) }}"><button class="btn btn-primary" type="button"
                            onClick="this.disabled=true; this.innerHTML='Submiting request, please wait...';">Pay
                            With Wallet Balance
