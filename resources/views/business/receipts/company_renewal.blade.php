...
<body onload="window.print()">
    ...
    <div class="receipt">
        ...
        <div class="item">
            <span>Applicant's Name</span><span>{{ $trx->company_name }}</span>
        </div>

        <div class="item">
            <span>Applicant's Email</span><span>{{ $trx->email }}</span>
        </div>

        <div class="item">
            <span>Applicant's Phone</span><span>{{ $trx->phone_number }}</span>
        </div>
        ...
        <!-- Items -->
        <div class="item">
            <span>Requested Service</span><span>Company Registration Renewal</span>
        </div>
