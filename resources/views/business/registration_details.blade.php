...
@section('content')
@section('title', env('APP_NAME') . ' | Company Registration Details')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
                <div class="mb-3 mb-md-0">
                    <h1 class="mb-1 h2 fw-bold">Company Registration Details</h1>
                    <!-- Breadcrumb -->
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#">Company Registration Details</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            ...
            <div class="card border-0 mb-4">
                ...
                <div class="card-header d-lg-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="mb-0">Company Registration Details
                        </h4>
                    </div>
                </div>
                                ...
                                @if ($company->operate_bank == 'yes')
                                    ...
                                    @if ($company->status == 'rejected')
                                        <tr>
                                            ...
                                            <td>{{ ucwords($company->rejection_reason) }}</td>
                                        </tr>
                                    @endif
                                @endif
                            @endif
