...
<head>
    ...
    <title>Power Of Attorney Application Approved</title>
    <style>
        body {
...
<body>
    <div class="container">
       ...
       <!-- Title -->
        <h1>Power Of Attorney Application Approved</h1>
        ...
        <!-- Message -->
        <p>
            We are pleased to inform you that your application for <strong>power of attorney </strong> has been
            successfully reviewed and approved.
        </p>
        <p>
            You can now download the approval letter by logging into your dashboard.
        </p>
