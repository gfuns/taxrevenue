...
<head>
  ...
  <title>Electricity Purchase Successful</title>
  <style>
    /* CSS Styles */
    body {
...
<body>
  <div class="container">
    ...
    <h2>Electricity Purchase Successful</h2>

    <p>Dear {{ $user->first_name." ".$user->last_name }},</p>

    <p>Your electricity purchase was successful. Here are the transaction details:</p>

    <table>
        <tbody>
          <tr>
            <th>Electricity Provider</th>
            <td>{{ $transaction->biller }}</td>
          </tr>
          <tr>
              <th>Meter Number</th>
