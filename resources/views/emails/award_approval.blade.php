...
<head>
    ...
    <title>Award Letter Application Approved</title>
    <style>
        body {
...
<body>
    <div class="container">
       ...
       <!-- Title -->
        <h1>Award Letter Application Approved</h1>
        ...
        <!-- Message -->
        <p>
            We are pleased to inform you that your application for <strong>award letter </strong> has been
