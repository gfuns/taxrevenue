...
<head>
    ...
    <title>Contractor Award Letter Application Pending Approval</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>This is to inform you that a contractor has submitted a request for Award Letter on the procurement
