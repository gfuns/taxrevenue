...
<head>
    ...
    <title>Processing Fee Remittance Approved</title>
    <style>
        body {
...
<body>
    <div class="container">
       ...
       <!-- Title -->
        <h1>Processing Fee Remittance Approved</h1>
        ...
        <!-- Message -->
        <p>
            We are pleased to inform you that your <strong>processing fee </strong> remittance has been
