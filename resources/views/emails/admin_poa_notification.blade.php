...
<head>
    ...
    <title>Contractor Power Of Attorney Application Pending Approval</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <!-- Title -->
        <h1>Contractor Power Of Attorney Application</h1>
        ...
        <p>This is to inform you that a contractor has submitted a request for Power Of Attorney on the procurement
