...
<head>
  ...
  <title>Data Subscription Successful</title>
  <style>
    /* CSS Styles */
    body {
...
<body>
  <div class="container">
    ...
    <h2>Data Subscription Successful</h2>

    <p>Dear {{ $user->first_name." ".$user->last_name }},</p>

    <p>Your data subscription was successful. Here are the transaction details:</p>
    ...
    <table>
        <tbody>
          ...
          <tr>
            ...
            <tr>
              <th>Data Plan</th>
              <td>{{ $transaction->plan_details }}</td>
            </tr>
            <tr>
              <th>Amount</th>
