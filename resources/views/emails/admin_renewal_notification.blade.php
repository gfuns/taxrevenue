...
<head>
    ...
    <title>Contractor Registration Renewal Application Pending Approval</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <!-- Title -->
        <h1>Contractor Registration Renewal Application</h1>
        ...
        <p>This is to inform you that a contractor has submitted a registration renewal application on the procurement
