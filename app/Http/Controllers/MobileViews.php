...
class MobileViews extends Controller
{
    ...
    public function userDetails($id = null)
    {
        if (Auth::user()) {
            ...
            return view("mobile.user_posts", compact("posts"));
        } else {
    ...
    public function bookmarks()
    {
        if (Auth::user()) {
            ...
            return view("mobile.bookmarks", compact("posts"));
        } else {
            return redirect()->route("forum.login");
        }
    }
    ...
    public function popularPosts()
    {
        ...
        return view("mobile.popular_posts", compact("popularPosts"));
    }

    public function categoryPosts($id)
    {
        $posts = ForumPosts::where("forum_category_id", $id)->get();
        return view("mobile.category_posts", compact("id", "posts"));
    }

    public function topicPosts($id)
    {
        $posts = ForumPosts::where("forum_topic_id", $id)->get();
        return view("mobile.topic_posts", compact("id", "posts"));
    }
    ...
    public function postDetails($id, $slug)
    {
        ...
        return view("mobile.post_details", compact("post", "comments", "postImages"));
    }
