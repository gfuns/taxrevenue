        ...
        if (isset($plan)) {
            ...
            if ($status === true) {
                ...
                return new JsonResponse([
                    'response' => [
                        'message' => 'Unable To Process Subscription',
                        'details' => 'We could not charge your selected card.',
                    ],
                ], 400);
            }
        } else {
            return new JsonResponse([
                'response' => [
                    'message' => 'Unable To Process Subscription',
                    'details' => 'Plan with the provided plan id does not exist',
                ],
            ], 400);
        }
    ...
    public function setAutoRenewal(Request $request)
    {
        ...
        if (isset($subscription)) {
            ...
            if ($subscription->save()) {
                ...
                return new JsonResponse([
                    'response' => [
                        'message' => 'Unable to set subscription auto renewal status',
                        'details' => 'Something went wrong',
                    ],
                ], 400);
            }
            ...
            return new JsonResponse([
                'response' => [
                    'message' => 'Successful',
                    'details' => 'Customer subscription with the provided subscription id does not exist.',
                ],
            ], 400);
        }
    }
